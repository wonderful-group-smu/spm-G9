...
def test_create_single_quiz_attempt(
    ...
    quiz_attempt_url = url_for('api.quiz_attempt', course_id=0, section_id=0, trainer_id=0, eng_id=0)

    request_json = {'course_id': quiz.course_id, 'section_id': quiz.section_id, "trainer_id": quiz.trainer_id, "eng_id": employee.id}

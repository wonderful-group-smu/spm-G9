...
def test_get_single_quiz_attempt(
    ...
    quiz_attempt_url = url_for('api.quiz_attempt', quiz_id=9999, course_id=9999, section_id=9999, trainer_id=9999, eng_id=9999)
...
def test_create_single_quiz_attempt(
    ...
    quiz_attempt_url = url_for('api.quiz_attempt', quiz_id=0, course_id=0, section_id=0, trainer_id=0, eng_id=0)

    request_json = {'course_id': quiz.course_id, 'section_id': quiz.section_id, "trainer_id": quiz.trainer_id, "eng_id": employee.id, "quiz_id": quiz.quiz_id, }

...
def init():
    ...
    course_class_one = CourseClass(course_id=1, trainer_id=2)
    course_class_two = CourseClass(course_id=2, trainer_id=2)
    course_class_three = CourseClass(course_id=2, trainer_id=4)
    course_class_four = CourseClass(course_id=2, trainer_id=5)
    course_class_five = CourseClass(course_id=2, trainer_id=6)
    ...
    class_section_two = ClassSection(course_id=2, trainer_id=6, section_name="Engineering Basics")
    class_section_three = ClassSection(course_id=2, trainer_id=6, section_name="Fighting Avengers")

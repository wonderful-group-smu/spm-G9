...
def init():
    ...
    # section_completed_two = SectionCompleted(section_id=2, course_id=1, trainer_id=2, eng_id=1)
    # section_completed_three = SectionCompleted(section_id=3, course_id=1, trainer_id=2, eng_id=1)

    items_to_add.append(section_completed_one)
    # items_to_add.append(section_completed_two)
    # items_to_add.append(section_completed_three)

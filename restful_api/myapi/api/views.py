...
api.add_resource(EnrollResource, "/enroll_by_ids/<int:eng_id>&<int:course_id>&<int:trainer_id>", endpoint="enroll_by_ids")
api.add_resource(EnrollResourceList, "/enroll/<int:eng_id>", endpoint="enroll")

    ...
    <div className='create-question-container'>
      <div className='question'>
        <h6>
          ...
          <button
            type='button'
            className='btn-sm btn-secondary delete-question'
          >
            <Im.ImBin className='bin-icon' onClick={deleteQuestion} /> Delete
            Question
          </button>
        </h6>
        <textarea
              ...
              {['A', 'B', 'C', 'D'].map((letter, i) => {
                return (
                  <div className='input-group' key={i}>
                    ...
                    <input
                      type='text'
                      className='form-control answer-option'
                      placeholder={'Input Option ' + letter + '...'}
                      aria-label={'option-' + letter}
                      aria-describedby={'option-' + letter}
                    ...
                    <div className='form-check' id='correct-answer'>
                      <OverlayTrigger
                        placement='top'
                        overlay={
                          <Tooltip>Set {letter} as correct answer</Tooltip>
                        }
                      >
                        <input
                          className='form-check-input'
